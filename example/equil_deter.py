...
parser.add_argument('-p', required=True, type=int, help='Percent of trajectory for which RMSD should be stable')
parser.add_argument('-l', required=True, type=int, help='Allowed fluctuations of RMSD at equilibrium(Angstrom)')
